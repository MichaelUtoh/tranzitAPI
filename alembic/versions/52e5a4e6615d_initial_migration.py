...
Revision ID: 52e5a4e6615d
Revises: 
Create Date: 2022-05-13 08:22:34.936516
...
def upgrade():
    ...
    op.drop_index('ix_documents_document_name', table_name='documents')
...
def downgrade():
    ...
    op.create_index('ix_documents_document_name', 'documents', ['document_name'], unique=False)
